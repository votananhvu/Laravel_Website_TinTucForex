...
<div class="col-md-12">
    <div class="card">
        <div class="card-header bg-warning">
            <a href="{{url('/admin/category/add')}}" title="Thêm mới">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="{{url('/admin/category/edit/'.$value->RowID)}}" title="Chỉnh sửa">
                                <i class="fas fa-edit mr-3"></i>
                            </a>
                            <a href="{{url('admin/category/delete/'.$value->RowID)}}" title="Xóa" onclick="return confirm('Bạn có muốn xóa?')">
